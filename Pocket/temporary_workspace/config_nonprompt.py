...
cfg = Configurator(
    ...
    variables={
        ...
        "nJets_recoil":      HistConf([Axis(coll="events", field="nJetGood_recoil", bins=12, start=0, stop=12, label="N(recoil jets)")]),
    ...
    columns = {
        "common": {
           "bycategory": {
                # "baseline": [ColOut("events",["nJetGood", "nJetGood_recoil", "nFatJetGood", "mt_w_leptonic", "nLeptonLoose","nLeptonGood","eta_w_lep","pt_w_lep"]), ColOut("PuppiMET", ["pt"])],
                "ele_ch": [ColOut("events",["nJetGood", "nJetGood_recoil", "nFatJetGood", "mt_w_leptonic", "nLeptonLoose","nLeptonGood","w_lep_eta","w_lep_pt"]), ColOut("PuppiMET", ["pt"])],
                "mu_ch": [ColOut("events",["nJetGood", "nJetGood_recoil", "nFatJetGood", "mt_w_leptonic", "nLeptonLoose","nLeptonGood","w_lep_eta","w_lep_pt"]), ColOut("PuppiMET", ["pt"])],
                "lele_ch": [ColOut("events",["nJetGood", "nJetGood_recoil", "nFatJetGood", "mt_w_leptonic", "nLeptonLoose","nLeptonGood","w_lep_eta","w_lep_pt"]), ColOut("PuppiMET", ["pt"])],
                "lmu_ch": [ColOut("events",["nJetGood", "nJetGood_recoil", "nFatJetGood", "mt_w_leptonic", "nLeptonLoose","nLeptonGood","w_lep_eta","w_lep_pt"]), ColOut("PuppiMET", ["pt"])],
                }
        }
    },
)
